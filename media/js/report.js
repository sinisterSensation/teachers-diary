...
const students = [
    {numbers: '1', name:'Александров Артур', marks:[2,2,3, 5, 4 ,3 ,5 ,4]},
    {numbers: '2', name:'Андреев Георгий', marks:[5, 4 ,3 ,5 ,4]},
    {numbers: '3', name:'Антонов Иван', marks:[5, 4 ,3 ,5 ,4]},
    {numbers: '4', name:'Архипова Елена', marks:[4,"НБ" ,"НБ" ,3]},
    {numbers: '5', name:'Баюков Кирилл', marks:[5, 4 ,"НБ" ,5 ,4]},
    {numbers: '6', name:'Боронин Артем', marks:[5, 4 ,3 ,5 ,4]},
    {numbers: '7', name:'Волков Семен', marks:[2, "НБ" ,3 ,5 ,4]},
    {numbers: '8', name:'Гаврилов Дмитрий', marks:[5, 4 ,3 ,5 ,4]},
    {numbers: '9', name:'Иванов Дмитрий', marks:[5, 4 ,3 ,5 ,4]},
    {numbers: '10', name:'Комиссаров Борис', marks:[5, 4 ,3 ,5 ,4]},
    {numbers: '11', name:'Краснов Максим', marks:[3 ,3 ,4]},
    {numbers: '12', name:'Лазарев Никита', marks:[5, "НБ" ,3]},
    {numbers: '13', name:'Мартынов Никита', marks:[5, "НБ" ,3 ,5 ,4]},
    {numbers: '14', name:'Назаров Станислав', marks:[5, 4 ,3 ,5 ,4]},
    {numbers: '15', name:'Наумов Данил', marks:[5, "НБ" ,3]},
    {numbers: '16', name:'Прокопьев Денис', marks:[5, 4 ,3 ,5 ,4]},
    {numbers: '17', name:'Романов Кирилл', marks:[5, "НБ" ,3]},
    {numbers: '18', name:'Сергеев Дмитрий', marks:[5, "НБ" ,3]},
    {numbers: '19', name:'Сергеев Кирилл', marks:[5, "НБ" ,3 ,5 ,4]},
    {numbers: '20', name:'Федорашко Сергей', marks:[4, 4 ,5 ,5 ,3 ,5]},
    {numbers: '21', name:'Федоров Иван', marks:[5, 5, 4 ,5 ,3]},
    {numbers: '22', name:'Федорова Анна', marks:[5, 4 ,3 ,5 ,4]},
    {numbers: '23', name:'Яковлев Сергей', marks:[5, "НБ" ,3]},
];
